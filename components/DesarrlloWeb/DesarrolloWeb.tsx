            ...
            <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
              ...
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    Implementación de medidas de seguridad, como certificados
                    SSL, para proteger la información del usuario y garantizar
              ...
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    Integración de prácticas de SEO para mejorar la visibilidad
                    en los motores de búsqueda y aumentar el tráfico orgánico.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    Enfoque en la creación de interfaces atractivas y la mejora
                    de la experiencia del usuario a través de interactividad y
            ...
            <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    Garantizar una alta disponibilidad del servidor y un tiempo
                    de actividad confiable para que el sitio esté accesible en
                    todo momento.
                  </p>
                </div>
              </div>
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    ...
                    garantizar tiempos de carga rápidos y un rendimiento
                    eficiente del sitio.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    ...
                    necesario para manejar el crecimiento del tráfico y la
                    demanda del sitio.
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    Proceso fácil y transparente para registrar y renovar
                    nombres de dominio, evitando complicaciones administrativas
                  </p>
                </div>
              </div>
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
              ...
              <div className="w-full sm:w-1/2 mb-4 px-2 ">
                <div className="h-full py-4 px-6 border border-cyan-800 border-t-0 border-l-0 rounded-br-xl">
                  ...
                  <p className="text-base text-grayDark dark:text-primaryDark">
                    ...
                    registrador si el cliente así lo desea, brindando
